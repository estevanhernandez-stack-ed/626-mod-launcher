...
public class GameProfileTests
{
    ...
    {
        var p = GameSaveTypesCatalog.Resolve("fromsoft", "1245620");
    ...
    {
        Assert.Empty(GameSaveTypesCatalog.Resolve("custom", null).SaveTypes);
        Assert.Empty(GameSaveTypesCatalog.Resolve(null, null).SaveTypes);
    }
}
